...
#define PanSource	"modelo_final.pml"
...
#define _nstates7	11	/* buffer_seguro */
#define minseq7	98
#define maxseq7	107
#define _endstate7	10

#define _nstates6	14	/* anti_starvation_worker2 */
#define minseq6	85
#define maxseq6	97
#define _endstate6	13

#define _nstates5	14	/* anti_starvation_worker1 */
#define minseq5	72
#define maxseq5	84
#define _endstate5	13

#define _nstates4	14	/* anti_starvation_worker0 */
#define minseq4	59
#define maxseq4	71
#define _endstate4	13

#define _nstates3	14	/* progreso */
#define minseq3	46
#define maxseq3	58
#define _endstate3	13

#define _nstates2	11	/* exclusion_mutua */
#define minseq2	36
#define maxseq2	45
#define _endstate2	10

#define _nstates1	21	/* Limpiador */
#define minseq1	16
#define maxseq1	35
#define _endstate1	20

#define _nstates0	17	/* Ingestor */
#define minseq0	0
#define maxseq0	15
...
typedef struct P7 { /* buffer_seguro */
...
typedef struct P6 { /* anti_starvation_worker2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* anti_starvation_worker1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* anti_starvation_worker0 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P2 { /* exclusion_mutua */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PLimpiador	((P1 *)_this)
typedef struct P1 { /* Limpiador */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PIngestor	((P0 *)_this)
typedef struct P0 { /* Ingestor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	unsigned mutex : 1;
	unsigned in_critical : 1;
	uchar worker_active[3];
	uchar buffer_count;
	uchar produced;
	uchar consumed;
	uchar worker_jobs[3];
