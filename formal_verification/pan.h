...
#define _nstates3	11	/* safety_buffer */
#define minseq3	41
#define maxseq3	50
#define _endstate3	10

#define _nstates2	14	/* liveness_property */
#define minseq2	28
#define maxseq2	40
#define _endstate2	13

#define _nstates1	16	/* Worker */
#define minseq1	13
#define maxseq1	27
#define _endstate1	15

#define _nstates0	14	/* Ingestor */
#define minseq0	0
#define maxseq0	12
...
typedef struct P3 { /* safety_buffer */
...
typedef struct P2 { /* liveness_property */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P0 { /* Ingestor */
	...
	unsigned _priority : 8; /* 0..255 */
#endif
	uchar items_produced;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, items_produced) - 1*sizeof(uchar))
